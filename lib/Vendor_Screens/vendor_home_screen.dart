  ...
  Widget _buildHeader() {
    return Row(
      children: [
        ...
        IconButton(
          onPressed: () {
            Navigator.pushNamed(context, vendorNotificationScreen);
          },
          ...
          children: [
            Row(
              ...
              children: [
                ...
                TextButton(
                  onPressed: () {
                    Navigator.pushNamed(context, vendorSalesStatisticsScreen);
                  },
                  child: const Text(
                    'View Analysis',
                    style: TextStyle(
      ...
      children: [
        ...
        Expanded(
          child: _buildStatCard(
            ...
            check: true,
            onTap: () {
              Navigator.pushNamed(context, vendorCommissionScreen);
            },
          ),
        ),
      ],
    ...
    return Row(
      ...
      children: [
        ...
        _buildActionButton(
          ...
          label: 'Transactions',
          onTap: () {
            Navigator.pushNamed(context, vendorTransactionHistoryScreen);
          },
        ),
        _buildActionButton(
          ...
          label: 'Withdraw',
          onTap: () {
            Navigator.pushNamed(context, vendorWithdrawalScreen);
          },
        ),
      ],
    );
