...
class _ForgotPasswordScreenState extends State<ForgotPasswordScreen> {
  ...
  // Repository instance
  late final PasswordResetRepo _passwordResetRepo;
  ...
  Future<void> _verifyOTP() async {
    ...
    try {
      final response = await _passwordResetRepo.verifyOTP(
          _verifiedEmail,
          otp
      );
  ...
  Future<void> _resendOTP() async {
    ...
    try {
      final response = await _passwordResetRepo.resendOTP(_verifiedEmail);
    ...
    return Form(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            "Enter your email and we'll send you a\n4-digit OTP to reset your password.",
            style: TextStyle(
              fontSize: 14,
